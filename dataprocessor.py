...
class DataProcessor(object):
	...
	def extract_all_features(self, all_var_modes = ["average", "maximum", "variance", "extremums", "average derivative", "average absolute derivative"], group_mode = "time", group_by = 20, distort = False):
		...
		all_varrays = []
		for var_modes in itertools.permutations(all_var_modes):
			print "Extracting features:", var_modes
			all_varrays += self.build_vars(var_modes, group_mode, group_by, distort)
			print "Features extracted:", var_modes
